...
//go:generate mockgen -package mocks -destination mocks/mocks_api.go github.com/ibiscum/Hands-On-Software-Engineering-with-Golang/Chapter12/dbspgraph/proto JobQueue_JobStreamServer
